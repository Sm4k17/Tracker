...
final class StatisticsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Аналитика: открытие экрана статистики
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        // Аналитика: закрытие экрана статистики
    ...
    private func updateUI(with statistics: TrackerStatistics?) {
        ...
        // Аналитика: обновление данных статистики
        AnalyticsService.shared.report(event: "update", params: [
            "screen": "Statistics",
